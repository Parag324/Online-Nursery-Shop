<div class="header-top">
       <div class="wrap"> 
              <div class="header-top-left">
                     ...
                     <a href="index.php"> <h5 style="padding-top: 20px;padding-bottom: 10px;font-size: 20px;"> Online Nursery Shop</h5></a>
...
?>
            <li><a class="active-icon c2" href="#"> </a>
                <ul class="sub-icon1 list">
                    ...
                    <li><p>Total Price:  RS<?php echo $resultss['total'];?></p></li>
                </ul>
            </li>
        </ul>
        
        <ul class="last"><li><a href="cart.php">Cart(<?php echo $resultss['totalp'];?>)  RS<?php echo $resultss['total'];?></a></li></ul>
      </div>
    </div>
     <div class="clear"></div>
     </div>
