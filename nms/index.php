...
<html>
<head>
<title>Nursery Shop System | Home Page</title>
  ...
  <!-- start slider -->
    <div id="fwslider">
        <div class="slider_container">
            <div class="slide"> 
                <!-- Slide image -->
                    <img src="images/slider2.jpg" width='200' height='350' alt=""/>
                <!-- /Slide image -->
                <!-- Texts container -->
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <!-- Text title -->
                        <h6 class="title">Plant trees save earth </h6>
                        <p class="description">#Go-Green</p>
                        <!-- /Text title -->
                    </div>
                </div>
                 <!-- /Texts container -->
            ...
            <div class="slide">
                <img src="images/slider3.jpg" width='200' height='350' alt=""/>
                <div class="slide_content">
                    <div class="slide_content_wrap"><br>
                        <h2 class="title">Greenary spreading in your house:)  </h2>
                        <p class="description">Delivers pure oxygen in your house !!</p>
                    </div>
                </div>
            </div>
            <!--/slide -->
				...
				<div class="inner_content clearfix">
                    ...
                    <div class="price">
					   <div class="cart-left">
							...
							<div class="price1">
							  <span class="actual">RS<?php echo $row['productPrice'];?></span>
							</div>
						</div>
